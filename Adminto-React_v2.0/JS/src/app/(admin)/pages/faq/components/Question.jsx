  ...
  return <>
      <form onClick={handleSubmit(() => {})}>
        <div className="border p-3 rounded bg-light-subtle">
          ...
          <div>
           <TextAreaFormInput control={control} name="question" type="text" label="Enter Your Question" className='form-control' id="schedule-textarea" rows={3} placeholder="Message" />
          </div>
          <div className="mt-2">
