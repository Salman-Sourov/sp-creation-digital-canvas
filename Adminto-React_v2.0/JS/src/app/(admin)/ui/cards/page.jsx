...
const CardWithImage2 = () => {
  return <Card className="d-block">
      ...
      <CardBody>
        <Link to="" className="card-link text-custom">Card link</Link>&nbsp;
        <Link to="" className="card-link text-custom">Another link</Link>
      </CardBody>
    </Card>;
};
  ...
  return <>
      ...
      <Col sm={6} lg={3}>
        <Card>
          ...
          <CardBody>
            <CardTitle as={'h5'}><Link to="" className="text-success stretched-link">Card with stretched link</Link></CardTitle>
      ...
      <Col sm={6} lg={3}>
        <Card>
          ...
          <CardBody>
            <CardTitle as={'h5'}><Link to="" className="stretched-link">Card with stretched link</Link></CardTitle>
            <p className="card-text">
              Some quick example text to build on the card up the bulk of the card&apos;s content.
            </p>
          </CardBody>
