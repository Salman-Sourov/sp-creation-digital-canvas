...
const EmailNavigationMenu = ({
  ...
  return <div className="card email-sidebar">
      <div className="offcanvas-xxl offcanvas-start" tabIndex={-1} id="email-sidebar" aria-labelledby="email-sidebarLabel">
        <CardBody>
          <div className="d-flex justify-content-between gap-2 align-items-center mb-2">
            ...
            <button type="button" className="btn btn-sm btn-icon btn-soft-danger ms-auto d-xl-none" data-bs-dismiss="offcanvas" data-bs-target="#email-sidebar" aria-label="Close">
