  ...
  return <Card>
      <Card.Body className="overflow-hidden">
        ...
        <ul className="nav nav-pills nav-justified form-wizard-header mb-3">
          {steps.map((step, idx) => <li key={idx} className="nav-item">
              <Button className={`nav-link rounded-0 py-2 ${activeStep === idx + 1 ? 'active' : ''}`} onClick={() => goToStep(idx + 1)}>
          ...
          <div>
            <Form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Form.Group as={Row} className="mb-3">
                ...
                <Col md={9}>
                  <Form.Control type="password" id="confirmPassword" placeholder="Confirm Password" {...register('confirmPassword', {
              ...
              <WizardButtons onPrev={prevStep} onNext={nextStep} activeStep={activeStep} totalSteps={steps.length} onFinish={finishStep} goToFirstStep={() => goToStep(1)} />
            </Form>
          </div>
          ...
          <div>
            <Form onSubmit={handleSubmit(onSubmit)}>
              <Form.Group as={Row} className="mb-3">
                ...
                <Col md={9}>
                  <Form.Control type="text" id="fname" placeholder="Enter first name" {...register('fname', {
              ...
              <Form.Group as={Row} className="mb-3">
                ...
                <Col md={9}>
                  <Form.Control type="text" id="lname" placeholder="Enter last name" {...register('lname', {
              ...
              <Form.Group as={Row} className="mb-3">
                ...
                <Col md={9}>
                  <Form.Control type="text" id="phone" placeholder="Enter phone number" {...register('phone', {
                ...
                <div className="text-center">
                  ...
                  <div className="mb-3">
                    <Form.Check type="checkbox" className="d-inline-block">
                      <Form.Check.Input type="checkbox" {...register('terms', {
...
const WizardWithProgressbar = () => {
  ...
  return <Card>
      <Card.Body className="overflow-hidden">
        ...
        <ProgressBar animated striped variant="success" style={{
        height: '7px'
      }} now={activeStep / 3 * 100} className="mb-3 progress-sm" />
